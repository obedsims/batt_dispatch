...
demand = pd.read_csv('batt_dispatch/data/demand.csv', index_col=0, header=None, parse_dates=True, squeeze=True)
pv_1kW = pd.read_csv('batt_dispatch/data/pv.csv', index_col=0, header=None, parse_dates=True, squeeze=True)
